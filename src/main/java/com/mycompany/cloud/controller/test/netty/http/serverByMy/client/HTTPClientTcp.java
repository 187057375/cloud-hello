...
public class HTTPClientTcp {
     ...
     * 发送HTTP_POST请求
     *
     *  you can see {@link HTTPClientTcp#sendPostRequest(String, Map, String)}
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, String> respMap = sendPostRequest("http://127.0.0.1:8080/tra/trade/noCardNoPassword.htm", params, "GB18030");
        System.out.println("=============================================================================");
